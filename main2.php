...
<ul class="navbar-nav ms-auto">
  <form class="form-inline my-2 my-lg-0">
    ...
    <button class="btn my-2 my-sm-0" id="searchBtn"  type="submit"><a href="almanac.html"><img src="assets/images/search.png"></a></button>
        ...
        <li class="nav-item"><a style="color: rgb(244, 236, 236);" class="nav-link active" href="index.html"><img src="assets/images/signin.png">SignOut</a></li>   
      </ul>
    </div>
  </div>
</nav>
...
<div class="container">
    <div class="content">
      <br><br><br>
      <h3 style="margin-left: 150px;">Welcome </h3><?php
        include('config.php');
        echo "<h3 style='margin-left: 10px;'>".$_REQUEST['uname']."</h3>";
    ?> <h3 style="margin-left: 10px;">To</h3><br>
...
<div class="info">
  ...
  <p style="margin-left: 15px; color: rgb(233, 225, 225);"><i class="bi-geo-alt-fill"></i> General Book Depot, Chowk Adda Hoshiarpur, Jalandhar city, Punjab</p>
